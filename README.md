...
- **Top 6 Continents by Average Temperature in 2024** 
  ![Top 6 Continenti per Temperatura Media 2024](results/img/C.%20temp%20media%20x%20continente%202024.png)
...
![Heatmap Variabilità Temperatura per Continente e Anno](results/img/C.%20heatmap%20variabilità%20temperatura%20continente%2014-24.png)

- **Average Diurnal Temperature Range (Tmax – Tmin) per Country – Last 5 Years**  
  ![Escursione Termica Media per Paese – Ultimi 5 Anni](results/img/P.%20escursione%20termica%20per%20paese%20last5y.png)
